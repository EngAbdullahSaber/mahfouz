  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20 will-change-transform">
        <div
          className="absolute top-20 left-20 w-72 h-72 rounded-full blur-3xl animate-pulse will-change-transform"
          style={{ backgroundColor: `${primaryColor}20` }}
        />
        <div
          className="absolute bottom-20 right-20 w-96 h-96 rounded-full blur-3xl animate-pulse delay-1000 will-change-transform"
          style={{ backgroundColor: `${primaryColor}20` }}
        />
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 rounded-full blur-3xl will-change-transform"
      ...
      >
        ...
        <div className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl will-change-transform">
          {/* Header Section */}
          <div className="text-center mb-16">
            <div
              className="inline-flex items-center justify-center w-24 h-24 rounded-3xl mb-6 shadow-2xl transform hover:scale-105 transition-all duration-500 hover:shadow-blue-500/25 will-change-transform"
              style={{ backgroundColor: primaryColor }}
            >
              <svg
                className="w-12 h-12 text-white will-change-transform"
                viewBox="0 0 24 24"
                fill="currentColor"
                aria-hidden="true"
              >
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto leading-relaxed will-change-transform">
              {t("tagline")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-8">
              <h3 className="text-2xl font-bold text-white text-center lg:text-right mb-8 will-change-transform">
                {t("downloadTitle")}
              </h3>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button
                  className="group flex items-center justify-center px-6 py-4 bg-gradient-to-r from-black/30 to-gray-900/30 hover:from-black/50 hover:to-gray-900/50 border border-white/20 hover:border-white/40 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl will-change-transform"
              ...
              <div className="grid grid-cols-1 gap-4">
                {contactInfo.map((item, index) => (
                  <Link
                    key={index}
                    href={item.href}
                    className="group flex items-center space-x-4 p-5 bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-lg border border-white/10 rounded-2xl hover:from-white/10 hover:to-white/15 hover:border-white/30 transition-all duration-300 hover:scale-105 hover:shadow-xl will-change-transform"
                  >
                    <div
                      className="flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-white/10 will-change-transform"
                      style={{ backgroundColor: `${primaryColor}20` }}
                    >
                      <div
                        className="group-hover:text-blue-300 transition-colors will-change-transform"
                    ...
                    <div className="flex-1 min-w-0 text-right">
                      ...
                      <p className="text-white font-semibold group-hover:text-blue-200 transition-colors flex items-center">
                        {item.value}
                        {item.href !== "#" && (
                          <ExternalLink className="w-4 h-4 ml-2 opacity-0 group-hover:opacity-100 transition-all duration-300 will-change-transform" />
                        )}
                      </p>
                    </div>
                  </Link>
          ...
          <div className="border-t border-white/10 pt-12 mb-12">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-white mb-8 will-change-transform">
                {t("social.title")}
              </h3>
              ...
              <div className="flex justify-center space-x-6">
                {socialLinks.map((social, index) => (
                  <Link
                    ...
                    className={`group relative w-16 h-16 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-2xl flex items-center justify-center text-gray-300 transition-all duration-300 hover:scale-110 hover:border-white/40 hover:shadow-xl ${social.color} will-change-transform`}
                    aria-label={social.name}
                  >
                    <div
                      className="absolute inset-0 rounded-2xl bg-gradient-to-r from-transparent to-transparent group-hover:from-blue-500/10 group-hover:to-blue-500/10 transition-all duration-300 will-change-transform"
                      style={{
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <p className="text-gray-400 text-center md:text-right will-change-transform">
                {t("copyright")}
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm">
                <Link
                  href="#"
                  className="text-gray-400 hover:text-white transition-colors hover:underline will-change-transform"
      ...
      <button
        ...
        className="fixed bottom-8 left-8 w-14 h-14 text-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 z-50 backdrop-blur-sm border border-white/20 will-change-transform"
        style={{ backgroundColor: primaryColor }}
        aria-label={t("scrollToTop")}
      >
        <svg
          className="w-6 h-6 mx-auto will-change-transform"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          aria-hidden="true"
